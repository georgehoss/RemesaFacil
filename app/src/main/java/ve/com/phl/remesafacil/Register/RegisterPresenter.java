...
public class RegisterPresenter implements RegisterContract.Presenter {
    ...
    @Override
    public void register(String firstName, String lastName, String number, String email, String password) {
        if (validData(firstName,lastName,number,email,password))
            mView.signUpUser(firstName,lastName,number,email,password);
    }

    @Override
    public boolean validData(String firstName, String lastName, String number, String email, String password) {
